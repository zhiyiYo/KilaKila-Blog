...
VALUES
  (
    ...
    '本文将会详细介绍在 VS Code 中使用 Qt 的正确姿势',
    1,
    'https://p2.music.126.net/Ke9ti8DAI2y7dcQTfGNMoA==/109951166194044451.jpg?param=180y180',
    '1',
    '0',
    105,
    '0',
    ...
    'adadaeqe',
    '实现屏幕截屏需要用到 Windows API，所以需要包括 Windows.h 头文件。同时我们想要对截图做进一步的处理，就需要用到 OpenCV。',
    2,
    'https://p1.music.126.net/0dym_keDqAbqYlOiQmUjiw==/109951164728012307.jpg?param=180y180',
    '0',
    '0',
    22,
    '0',
    ...
    '如何实现 SSD 目标检测算法',
    'asdasda',
    'SSD 的全称是 Single Shot MultiBox Detector，它和 YOLO 一样，是 One-Stage 目标检测算法中的一种',
    1,
    'https://p2.music.126.net/Ok1rt3Ka_owixH5IsvGS2g==/109951164728031188.jpg?param=180y180',
    '0',
    '0',
    33,
    '0',
    ...
    'matplotlib 功能十分强大，就是工具栏丑了点。忍了一个学期之后，还是决定自己动手，魔改一波 matplotlib 的工具栏样式。',
    2,
    'https://p2.music.126.net/sSxbRt9RpC6s_MaewyDJfA==/18597139672292692.jpg?param=180y180',
    '0',
    '0',
    44,
    '0',
